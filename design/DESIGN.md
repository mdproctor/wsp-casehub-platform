...
JWT claim (defaults false). isCrossTenantAdmin() defaults to false everywhere; the mock
exposes it via casehub.platform.principal.crossTenantAdmin for local simulation. A companion
